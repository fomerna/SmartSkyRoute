...
<script src="/resources/easyAutocomplete.js"></script>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a
                ...
                en-USD</a> <a class="btn btn-sm btn-primary-outline display-4"
                              href="">
        ...
        <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                    <span class="nav-link active" id="pills-home-tab"
                          ...
                          aria-selected="true"
                          style="margin-right: 20px">Return</span>
            </li>
            <li class="nav-item">
                    <span class="nav-link" id="pills-profile-tab"
                          data-toggle="pill" href="#pills-profile" role="tab"
                          aria-controls="pills-profile" aria-selected="false">Multi-City</span>
            </li>
        </ul>
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="autocomplete">
                            ...
                            <input class="border-right border-left " id="arv"
                                   type="text"
                                   name="arv" placeholder="To">
                        </div>

                        <%-- 가는날 --%>
                        <div class="form-group">
                            <label for="depTime"
                                   class="col-form-label">Depart</label>
                        ...
                        <div class="form-group">
                            <label for="arvTime"
                                   class="col-form-label">Return</label>
                ...
                <form>
                    <div class="row justify-content-md-center" id="multi-input">
                        ...
                        <div class="autocomplete2">
                            <label for="multi-dep1"
                                   class="col-form-label">From</label>
                            <input class="rounded" id="multi-dep1"
                                   type="text"
                                   name="multi-dep1" placeholder="From">
                        </div>
                        ...
                        <div class="autocomplete2"
                            ...
                            <label for="arv"
                                   class="col-form-label">To</label>
                            <input class="border rounded" id="multi-arv1"
                                   type="text"
                                   name="multi-arv1" placeholder="To">
                        </div>

                        <div class="form-group2" style="margin-right: 30px">
                            <label for="multi-time1"
                                   class="col-form-label">Depart</label><br/>
...
<div id="pre_set" style="display:none" class="justify-content-md-center">
    <div class="row justify-content-md-center" id="multi-input2">
        ...
        <%-- 출발지 --%>
        <div class="autocomplete2">
            <label for="multi-dep2"
                   class="col-form-label">출발지</label>
            <input class="rounded" id="multi-dep2"
                   type="text"
        ...
        <div class="array">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 24 24" width="25" height="25"
                 style="width: 1.125rem; height: 1.125rem;margin-top: 27px;margin-right: 5px;">
                <path d="M9.9 19.7L17 12 9.9 4.4c-.7-.7-1.7-.2-1.7.7v14c0 .8 1 1.3 1.7.6z"/>
            </svg>
        </div>
        ...
        <div class="autocomplete2"
             style="margin-right: 30px">
            <label for="multi-arv2"
                   class="col-form-label">도착지</label>
            <input class="border-right rounded" id="multi-arv2"
                   type="text"
                   name="arv3" placeholder="도시 또는 공항">
        </div>

            <%-- 가는날 --%>
        <div class="form-group2" style="margin-right: 30px">
            <label for="multi-time2"
